...
import intStyles from '../../interview/Interview.module.css';
import type { QuestionDto, CollectionDto } from '../../interview/types/interview';
import { MdAdd, MdEdit, MdDelete, MdSave, MdClose, MdVisibility, MdSearch, MdInbox } from 'react-icons/md';
import ReactMarkdown from 'react-markdown';
import remarkGfm from 'remark-gfm';

import { useToast } from '../../../shared/components/Toast/Toast';
import { useConfirm } from '../../../shared/stores/uiStore';
import { 
    useQuestionsAdmin, 
    useUpsertQuestion, 
    useDeleteQuestion, 
...
const InterviewAdmin: React.FC = () => {
    ...
    // Queries
    const { data: questions = [], isLoading: isQuestionsLoading } = useQuestionsAdmin();
    const { data: categories = [], isLoading: isCategoriesLoading } = useCategories();
    const { data: sets = [], isLoading: isSetsLoading } = useSets();

    const isLoading = isQuestionsLoading || isCategoriesLoading || isSetsLoading;

    // Mutations
    const upsertQuestionMutation = useUpsertQuestion();
    const deleteQuestionMutation = useDeleteQuestion();
    const upsertCollectionMutation = useUpsertCollection();
    ...
    const handleSaveQuestion = () => {
        upsertQuestionMutation.mutate(currentQuestion, {
            onSuccess: () => {
    ...
    const handleSaveCollection = () => {
        ...
        upsertCollectionMutation.mutate(collectionToSave, {
            onSuccess: () => {
                    ...
                    >
                        ...
                        >
                            ...
                            <div className={styles.modalFooter}>
                                ...
                                <button className={styles.btnPrimary} onClick={handleSaveQuestion} disabled={upsertQuestionMutation.isPending}>
                                    <MdSave /> {upsertQuestionMutation.isPending ? 'Saving...' : 'Save Question'}
                                </button>
                            </div>
                        </motion.div>
                    </motion.div>
                    ...
                    >
                        ...
                        >
                            ...
                            <div className={styles.modalFooter}>
                                ...
                                <button className={styles.btnPrimary} onClick={handleSaveCollection} disabled={upsertCollectionMutation.isPending}>
                                    <MdSave /> {upsertCollectionMutation.isPending ? 'Saving...' : 'Save Collection'}
                                </button>
                            </div>
                        </motion.div>
                    </motion.div>
